  ...
  return (
    <span
      ...
      className={cn(
        ...
        "bg-zinc-900 text-white ring-2 ring-white dark:bg-white dark:text-zinc-900 dark:ring-zinc-900",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "bg-zinc-100 text-zinc-600 ring-2 ring-white",
        "dark:bg-zinc-800 dark:text-zinc-300 dark:ring-zinc-900",
