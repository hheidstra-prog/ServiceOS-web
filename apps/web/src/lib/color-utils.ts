 ...
 *
 * The input hex is analyzed for its hue and peak chroma. Each shade
 * gets a fixed lightness and a chroma scaled from the source color's
 * maximum, ensuring the palette feels coherent.
 */
